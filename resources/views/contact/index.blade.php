    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="post">
        ...
        <div class="mb-4">
          ...
          <input id="name_kana" name="name_kana" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）タナカタロウ" value="{{ old('name_kana') }}">
        ...
        <div class="mb-4">
          ...
          <input id="phone" name="phone" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）0312345678" value="{{ old('phone') }}">
        ...
        <div class="mb-4">
          ...
          <input id="email" name="email" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="email" placeholder="info@example.com" value="{{ old('email') }}">
        ...
        <div class="mb-4">
          ...
          <textarea id="body" name="body" class="w-full h-24 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="ご自由にご記入ください">{{ old('body') }}</textarea>
